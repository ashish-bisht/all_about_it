...
const topic_trees = {
    id: "trees",
    title: "Tree Mastery",
            problem: "Goal: Solve the problem 'Tree Mastery' and return the required output as per the prompt.",
...
return left if left else right`,
    ...
    return left_result if left_result else right_result`
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Serialize & Deserialize' and return the required output as per the prompt.",
...
def deserialize(self, data):
    ...
    def deserialize(self, data):
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Maximum Path Sum' and return the required output as per the prompt.",
...
def maxPathSum(self, root):
    ...
    def maxPathSum(self, root):
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Construct Tree (Pre+In)' and return the required output as per the prompt.",
...
return build(0, len(inorder) - 1)`,
    ...
    return build(0, len(inorder) - 1)`
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Largest BST in Binary Tree' and return the required output as per the prompt.",
...
return postorder(root)[2]`,
    ...
    return postorder(root)[2]`,
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Burn a Binary Tree' and return the required output as per the prompt.",
...
return max_time`,
    ...
    return max_time  # Last node infected hone ka time`,
        ...
        },
        {
            ...
            problem: "Goal: Solve the problem 'Vertical Order Traversal' and return the required output as per the prompt.",
...
return res`,
    ...
    return result`
        ...
        },
        {
            id: "lca-bst",
            title: "LCA in BST",
            problem: "Goal: Solve the problem 'LCA in BST' and return the required output as per the prompt.",
...
window.currentTopicData = topic_trees;
